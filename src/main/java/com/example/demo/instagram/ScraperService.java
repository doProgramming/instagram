...
public interface ScraperService {
    Comment sendCommentGiveResponse(String usernameLogin, String comment, String password, String userFrom, String mediaId) throws IOException,ClassNotFoundException;
    UserData getDataNoProxy(String usernameLogin, String password, String userFrom) throws IOException, ClassNotFoundException;
